# Pkuhollow(新未名树洞) Backup Project
...
在我作为初学者学习Python的过程中，为了能将自己在Pkuhollow上的回忆进行个人备份，我编写了这个小脚本。它能够将Hollow的帖子、回复以及其中包含的图片都完整地下载到本地。
...
#### 主帖活跃度
![树洞主帖活跃度图表](posts_activity_chart.png)
#### 评论活跃度
![树洞评论活跃度图表](comments_activity_chart.png)
* 可以看出大家对未名洞的使用习惯和qy洞非常相似。此前有大佬分析了2016-2019年的（前）qy洞数据，得出结论为大家**最喜欢**在23:00-24:00刷树洞，**最不喜欢**在5:00-6:00刷树洞。
...
但我希望将它分享给真正有需求、并了解其工作原理的朋友，也非常欢迎有识之士为我的项目提出反馈与建议！如需访问本项目的代码，请您创建新的Issue联系我~
